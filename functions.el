...
;; Time-stamp: <2026-05-07 13:23:14 f205200>
...
(global-set-key (kbd "C-c C-f") 'my-insert-file-name) ;; insert filename at point
...
;; courtesy of ChatGPT
(defun my-isert-lm-glossa ()
  "Inserisce '[LM:   ]' e sposta il cursore indietro di un carattere."
  (interactive)
  (insert "[LM:   ]")
  (backward-char 3))

(global-set-key (kbd "C-c C-n") 'my-isert-lm-glossa)
